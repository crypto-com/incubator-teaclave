...
/// Should this be `SgxEcdsaQuotePkType`?
#[derive(Debug, PartialEq)]
...
/// # Note
///
/// The names are a bit confusing here. Ideally, both `SgxQute` and `AttestationReport` should be merged and called
/// `SgxQuote` and `EndorsedAttestationReport` should be called `AttestationReport`.
#[derive(Debug)]
